...
const Sidebar = () => {
  ...
  const navItems = [
    ...
    { text: 'Request a Caregiver', icon: <People />, path: '/dashboard/request' },
    { text: 'My Requests', icon: <ListAlt />, path: '/dashboard/my-requests' },
    { text: 'Interested Caregivers', icon: <ListAlt />, path: '/dashboard/interest-caregiver' },
    { text: 'Approved Caregivers', icon: <ListAlt />, path: '/dashboard/approved-caregiver' },
