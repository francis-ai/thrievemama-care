...
const Hero = () => {
  ...
  const getImageUrl = (filename) =>
    filename ? `http://localhost:5000/uploads/website-settings/${filename}` : '';
      ...
      <div className="hero-content">
        ...
        >
          ...
          <div className="hero-buttons">
            <Link to="/waiting-list" className="btn btn-left mb-2">Get Started</Link>
            <Link to="/waiting-list" className="btn btn-right mb-2">Learn More</Link>
          </div>
        </motion.div>
